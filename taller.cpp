...
void modificarEstudiante()
{
    ...
    if (archivo.is_open())
    {
        ...
        {
            if (buscarcarnet == e.carnet)
            {
                cout << "Ingrese el nuevo nombre del estudiante: ";
                cin >> e.nombre;
                cout << "Ingrese la nueva edad del estudiante: ";
                cin >> e.edad;
                ofstream archivoModificado("estudiantes.txt", ios::app);
                archivoModificado << e.nombre << " " << e.carnet << " " << e.edad << endl;
                archivoModificado.close();
                cout << "Estudiante modificado con éxito.\n";
                return;
            }
        }
        archivo.close();
...
void eliminarEstudiante()
{
    ...
    if (archivo.is_open() && temp.is_open())
    {
        ...
        if (eliminado)
        {
            ...
            else cout << "Carnet no encontrado.\n";
        }
        else
        {
